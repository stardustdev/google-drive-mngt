...
const FileCard: FC<FileCardProps> = ({ file, onAction }) => {
  ...
  return (
    <div
      className={`bg-card rounded-lg border border-border hover:shadow-md transition-all hover:border-primary ${isFolder ? "cursor-pointer" : "cursor-pointer"}`}
        ...
        <div className="flex items-start justify-between">
          <div className="overflow-hidden">
            ...
            >
              {isFolder && (
                <span
                  className="material-icons mr-1 text-primary align-text-bottom"
